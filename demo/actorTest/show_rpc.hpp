...
public:
    ...
    int show_io()
    {
        ...
        static long last_syncCall = 0, last_asyncCall = 0;
        static long last_syncCallRep = 0, last_asyncCallRep = 0;
        static auto start_time = system_clock::now();
        static auto last_time  = system_clock::now();
        auto        now        = system_clock::now();

        if (show_title++ % 10 == 0) {
            long s = g_syncCall, s1 = g_syncCallRep;
            long r = g_asyncCall, r1 = g_asyncCallRep;
